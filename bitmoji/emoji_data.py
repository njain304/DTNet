...
if __name__ == "__main__":
    ...
    while i < args.num:
        with open('./bitmoji/bitmoji_properties.json') as json_file:
            ...
            request = 'https://render.bitstrips.com/render/6688424/' + user_id + '-v1.png?colours=' + colors + '&pd2=' + attributes + '&head_rotation=0&proportion=' + str(
                proportion) + '&sex=' + str(gender) + '&scale=0.382&style=1'
