...
class digits_model_test(BaseTest):
    ...
    def create_data_loaders(self):
        ...
        s_train_set = celebA.CelebA(data_dir = '/Users/gali/Downloads/dt/data/celebA/images/', annotations_dir='/Users/gali/Downloads/dt/data/celebA/annotations', split='train', transform = SVHN_transform)
        self.s_train_loader = torch.utils.data.DataLoader(s_train_set, batch_size=128,
                                          shuffle=True, num_workers=8)
        
        t_train_set = simpsons.Simpsons(data_dir='/Users/gali/Downloads/dt/data/simpsons', split='train', transform = MNIST_transform)
        self.t_train_loader = torch.utils.data.DataLoader(t_train_set, batch_size=128,
                                          shuffle=True, num_workers=8)

        s_test_set = celebA.CelebA(data_dir = '/Users/gali/Downloads/dt/data/celebA/images/', annotations_dir='/Users/gali/Downloads/dt/data/celebA/annotations',split='test', transform = SVHN_transform)
        self.s_test_loader = torch.utils.data.DataLoader(s_test_set, batch_size=128,
                                         shuffle=False, num_workers=8)
        
        t_test_set = simpsons.Simpsons(data_dir='/Users/gali/Downloads/dt/data/simpsons', split='test', transform = MNIST_transform)
    ...
    def create_model(self):
        ...
        self.readClassifier('/Users/gali/Downloads/dt/pretrained_model/model_F_SVHN_NormRange.tar')
        
        #Test
        model = torch.load('/Users/gali/Downloads/dt/pretrained_model/model_classifier_MNIST_NormRange.tar', map_location=lambda storage, loc: storage)
    ...
    def train_model(self, num_epochs, **kwargs):
        ...
        logdir = '/Users/gali/Downloads/dt/log/' + str(int(time.time()))
        os.mkdir(logdir)
