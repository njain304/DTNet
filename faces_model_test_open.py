...
class FaceTest(BaseTrain):
    ...
    def init_optimizer(self):
        ...
        generator_decay = 0
        self.generator_optimizer = optim.Adam(self.model['G'].parameters(), lr=generator_learning_rate, betas=(0.9, 0.999), weight_decay=generator_decay)

        discriminator_learning_rate = 5e-4
        discriminator_decay = 0  # 1e-6
        self.discriminator_optimizer = optim.Adam(self.model['D'].parameters(), lr=discriminator_learning_rate, betas=(0.9, 0.999), weight_decay=discriminator_decay)
